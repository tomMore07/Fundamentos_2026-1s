...
public class Empresa {
	...
	public static void main(String[] args) {
		...
		ProductoNoPerecedero productoNP1 = new ProductoNoPerecedero(1023, "Alimento", 15.50, 'A' );
		ProductoNoPerecedero productoNP2 = new ProductoNoPerecedero(1072, "Lacteo", 11.20, 'B' );
		ProductoNoPerecedero productoNP3 = new ProductoNoPerecedero(1049, "Lacteo", 18.70, 'Z' );
